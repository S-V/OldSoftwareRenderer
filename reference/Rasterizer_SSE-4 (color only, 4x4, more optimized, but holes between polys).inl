		...
		for( UINT iBlockX = nMinX; iBlockX < nMaxX; iBlockX += BLOCK_SIZE_X )
		{
...

			{
				...
				for( UINT iY = iBlockY; iY < iBlockY + BLOCK_SIZE_Y; iY++ )
				{
					...
					const __m128i cx1_mask = _mm_cmplt_epi32( qiCX1, _mm_setzero_si128() );
					const __m128i cx2_mask = _mm_cmplt_epi32( qiCX2, _mm_setzero_si128() );
					const __m128i cx3_mask = _mm_cmplt_epi32( qiCX3, _mm_setzero_si128() );
